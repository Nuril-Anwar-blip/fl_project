 ...
 * Deskripsi: Sidebar responsif dengan mode expand/collapse dan varian item/menu.
 * Ketergantungan: Radix (`@radix-ui/react-slot`), util `cn`, komponen UI internal, serta hook `useIsMobile`.
 * Model Pemakaian (React TS murni):
 * - Bungkus layout dengan <SidebarProvider> lalu gunakan <Sidebar>, <SidebarContent>, <SidebarMenu>, dst.
 * - Mendukung sidebar mobile via `Sheet` dan kontrol `useSidebar()`.
 * Catatan: Komponen kompleks namun tetap UI-only; adaptasi cookie/state bekerja di React murni.
 */
