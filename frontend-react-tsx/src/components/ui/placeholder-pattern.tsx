/**
 * Dokumentasi: Komponen PlaceholderPattern
 * Deskripsi: SVG pola placeholder untuk dekorasi area kosong.
 * Ketergantungan: React bawaan (hooks `useId`).
 * Model Pemakaian (React TS murni):
 * - <PlaceholderPattern className="h-32 w-full" />
