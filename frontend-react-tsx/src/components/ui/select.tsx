/**
 * Dokumentasi: Komponen Select
 * Deskripsi: Input pilihan (dropdown) berbasis Radix UI yang dapat dikustomisasi.
 * Ketergantungan: `@radix-ui/react-select`, `lucide-react`, util `cn`.
 * Sub-komponen: `SelectTrigger`, `SelectContent`, `SelectItem`, `SelectValue`.
 * Model Pemakaian:
